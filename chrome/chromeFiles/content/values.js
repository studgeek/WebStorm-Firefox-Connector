...
ValuesRegistry.prototype.sendValue = function(connector, id, name, value) {
  ...
  if (jsType == JBExtension.Services.jsdIValue.TYPE_FUNCTION) {
    stringValue = "function " + value.jsFunctionName + "()";
  }
  else if (jsType == JBExtension.Services.jsdIValue.TYPE_OBJECT && value.jsClassName != "Error") {
    stringValue = value.jsClassName;
  }
  else if (jsType == JBExtension.Services.jsdIValue.TYPE_INT) {
    stringValue = "" + value.intValue;
  }
  else if (jsType == JBExtension.Services.jsdIValue.TYPE_BOOLEAN) {
    stringValue = "" + value.booleanValue;
  }
  ...
  if (!stringValue) {
    stringValue = "" + value.getWrappedValue();
  }
