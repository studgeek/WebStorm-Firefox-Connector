...
JBExtension.Debugger = {
  ...
  start: function(connector) {
    ...
    JBExtension.BreakpointManager.connector = connector;
    JBExtension.BreakpointManager.clearData();
    JBExtension.ScriptManager.connector = connector;
  ...
  pause: function() {
    ...
    if (!this.jsd.interruptHook) {
      new SteppingHook(this.jsd, this.framesList.depth, Number.MAX_VALUE).setupHooks();
    }
  },
...
SteppingHook.prototype.setupHooks = function() {
  var hook = this;
