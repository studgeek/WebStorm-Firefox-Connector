JBExtension.JBConnector = {
  ...
  connect: function (host, port) {
    ...
    this.socket = JBExtension.Sockets.createSocket(host, port, this);
    this.connected = true;
  ...
  sendScriptCreatedResponse: function(info) {
    this.sendResponse(-1, "scriptCreated", "url", info.url, "tag", info.tag, "fun", this.getFunName(info.functionName),
                      "baseLine", info.getBaseLineNumber(), "lineExtent", info.getLineExtent(), "text", this.getFunName(info.getSourceText()));
  },
